      ...
      <header className="w-full bg-white text-black border-b border-gray-200">
        <div className="relative max-w-7xl mx-auto px-4 py-4 sm:py-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            ...
            <Link
              href="/"
              className="text-3xl sm:text-4xl font-serif font-bold hover:text-red-600 transition-colors tracking-tight px-4"
            >
              The Samachar
            </Link>
            ...
            <div className="flex-1 flex justify-end">
              <Link href="/newsletter">
                <button className="group relative inline-flex items-center justify-center">
                  ...
                  {/* Tablet/Desktop view */}
                  <div className="hidden sm:flex items-center px-4 py-2 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors">
